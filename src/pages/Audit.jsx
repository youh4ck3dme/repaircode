              ...
              <form onSubmit={handleSubmit} className="space-y-8 md:space-y-12">
                ...
                <div className="pt-4 md:pt-6">
                  <motion.button
                    ...
                    className="w-full px-6 md:px-8 py-4 md:py-5 bg-accent text-black rounded-xl md:rounded-2xl font-bold text-lg md:text-xl hover:bg-white transition-all duration-300 disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center gap-3 shadow-xl active:scale-95"
                  >
